...
class DuelingDQN(nn.Module):
    def __init__(self, image_shape, output_size):
        ...
        self.filter1 = nn.Conv2d(in_channels, out_channels=64,kernel_size=(8, 8), stride=(4, 4))
        self.filter2 = nn.Conv2d(in_channels=64, out_channels=128,kernel_size=(4, 4), stride=(2, 2))
        self.filter3 = nn.Conv2d(in_channels=128, out_channels=128,kernel_size=(3, 3), stride=(1, 1))
