...
from emulator.env_data import high2low, fix_data , get_test_data
...
quotes = get_test_data('./tickdata/HS300_test.csv')
...
end_date = pd.to_datetime('2018-02-1')
...
class Account(object):
    ...
    def step_op(self, action, printable):
        ...
        #print('%s %f %f %f'%(action,reward,self.total_value,self.cash))
